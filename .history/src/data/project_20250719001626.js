...
const projects = [
    ...
    {
        title: "Game Time",
        features: "A single player game that allows users to play and enjoy their free time.",
        bg: project4,
        github: "",
    ...
    },
    {
        ...
        features: "An application that provides QR code for any public link or PDF file, making the accessibility e.",
        bg: project5,
        github: "",
