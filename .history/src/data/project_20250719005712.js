...
const projects = [
    ...
    },
    {
        ...
        description: "Circle is a social networking site that allows users to connect, share, and collaborate on various topics. It provides a platform for users to create profiles, post updates, and engage with others through comments and likes. The site is designed to foster community interaction and knowledge sharing.",
    ...
    },
    {
        ...
        description: "AI-Debugger is a tool designed to assist developers in debugging their code efficiently. It leverages AI algorithms to analyze code, identify potential issues, and suggest fixes. The tool supports multiple programming languages and integrates seamlessly with popular IDEs, making it a valuable asset for developers looking to streamline their debugging process.",
